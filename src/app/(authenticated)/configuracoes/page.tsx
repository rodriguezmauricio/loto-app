                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.container}>
                        ...
                        <ConfigOptionsCard
                            ...
                            value={
                                setting.surpresinha_permitirCadastroIlimitadoDeBilhetesDuplicados
                            }
                        />
                    </div>
                </section>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.container}>
                        <ConfigOptionsCard
                            ...
                            value={
                                setting.permissoesAdm_ativarValidacaoDeQuantidadeMaxDeBilhetesParaOsAdmins
                            }
                        />
                        <ConfigOptionsCard
                            type="switch"
                            ...
                            value={
                                setting.permissoesAdm_ativarValidacaoDoValorMaxPorBilhetesParaOsAdmins
                            }
                        />
                        <ConfigOptionsCard
                            type="switch"
                        ...
                        <ConfigOptionsCard
                            ...
                            value={
                                setting.permissoesAdm_ativarValidacaoDoHorarioDeBloqueioParaOsAdmins
                            }
                        />
                        <ConfigOptionsCard
                            type="switch"
                            ...
                            value={
                                setting.permissoesAdm_ativarValidacaoDoHorarioDeInicioDasVendasParaOsAdmins
                            }
                        />
                    </div>
                </section>
